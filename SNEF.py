...
parser.add_argument("-a", type=str, help="full path to alignability track",required=False)
parser.add_argument("-b", type=str, help="full path to exome bed file",required=False)
...
## Write the command line parameters to a log file
#print(vcfpath)
#print(tbampath)
#print(nbampath)
...
#Depth - produces same counts as IGV
